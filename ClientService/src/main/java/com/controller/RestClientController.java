...
public class RestClientController {
 ...
 public void getPhoto(@RequestParam("id") final Long id, final HttpServletResponse response) {
 ...
 public String getAll(final Model model) {
  ...
  // Send the request as GET
  try {
   ResponseEntity<PersonList> result = restTemplate.exchange("http://localhost:8081/ProviderService/provider/persons", HttpMethod.GET, entity, PersonList.class);
   // Add to model
 ...
 public String getPerson(@RequestParam("id") final Long id, final Model model) {
 ...
 public String addPerson(@ModelAttribute("personAttribute") final Person person,
       final Model model) {
 ...
 /**
    ...
    public String getUpdatePage(@RequestParam(value="id", required=true) final Integer id,  
              final Model model) {
 ...
 public String updatePerson(@ModelAttribute("personAttribute") final Person person,
 ...
 public String deletePerson(@RequestParam("id") final Long id,
          final Model model) {
